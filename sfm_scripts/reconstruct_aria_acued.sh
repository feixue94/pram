...
dataset=/scratches/flyer_3/fx221/dataset/ACUED/cued/
db_image_dir=$dataset/db
query_image_dir=$dataset/query
outputs=/scratches/flyer_2/fx221/localization/outputs/ACUED/cued
query_pair=$dataset/pairs-query-20.txt
gt_pose_fn=$dataset/queries_poses.txt
save_root=$root_dir/fx221/exp/sgd2/ACUED/cued
