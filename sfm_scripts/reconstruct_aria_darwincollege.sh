...
dataset=/scratches/flyer_3/fx221/dataset/Darwin/darwin
db_image_dir=$dataset/db
query_image_dir=$dataset/query
outputs=/scratches/flyer_2/fx221/localization/outputs/Darwin/darwin
query_pair=$dataset/pairs-query-30.txt
gt_pose_fn=$dataset/queries_pose.txt
save_root=$root_dir/fx221/exp/sgd2/Darwin/darwin
